...
Cube::Cube() : TriangleMesh() {
	...
	m_vertices.push_back(Vertex(p3, uv4, n2));
	m_vertices.push_back(Vertex(p8, uv5, n2));
	m_vertices.push_back(Vertex(p4, uv6, n2));

	m_vertices.push_back(Vertex(p7, uv7, n3));
	m_vertices.push_back(Vertex(p6, uv8, n3));
	m_vertices.push_back(Vertex(p8, uv5, n3));

	m_vertices.push_back(Vertex(p2, uv9, n4));
	m_vertices.push_back(Vertex(p8, uv10, n4));
	m_vertices.push_back(Vertex(p6, uv8, n4));

	m_vertices.push_back(Vertex(p1, uv11, n5));
	m_vertices.push_back(Vertex(p4, uv12, n5));
	m_vertices.push_back(Vertex(p2, uv13, n5));

	m_vertices.push_back(Vertex(p5, uv14, n6));
	m_vertices.push_back(Vertex(p2, uv9, n6));
	m_vertices.push_back(Vertex(p6, uv15, n6));

	m_vertices.push_back(Vertex(p7, uv16, n1));

	m_vertices.push_back(Vertex(p7, uv7, n2));

	m_vertices.push_back(Vertex(p5, uv17, n3));

	m_vertices.push_back(Vertex(p4, uv18, n4));

	m_vertices.push_back(Vertex(p3, uv19, n5));

	m_vertices.push_back(Vertex(p1, uv20, n6));
	...
	for (int i = 0; i < 36; i += 3) {
		m_triangles.push_back(std::make_unique<Triangle>(&m_vertices[indices[i]],
